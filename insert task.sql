...
CREATE TABLE courses (
    ...
    alter table courses modify column room_number VARCHAR(200);
    alter table courses modify column department VARCHAR(200);
    alter table courses modify column instructor VARCHAR(200);
...
CREATE TABLE movies (
    ...
    alter table movies modify column production_company varchar(100);
    alter table movies modify column  title VARCHAR(200);
    alter table movies modify column  director VARCHAR(230);
    alter table movies modify column  genre VARCHAR(90);
    alter table movies modify column language VARCHAR(100);
...
CREATE TABLE hotels (
    ...
    select * from hotels;
    alter table hotels modify column hotel_name VARCHAR(200);
	alter table hotels modify column  location VARCHAR(200);
	alter table hotels modify column room_type VARCHAR(200);
	alter table hotels modify column hotel_description VARCHAR(200);
    
    INSERT INTO hotels(hotel_id, hotel_name, location, rating, price, room_type, availability, hotel_description)
VALUES
...
CREATE TABLE mobile_phones (
    phone_id INT,
    phone_brand VARCHAR(200),
    phone_model VARCHAR(140),
    release_year INT,
    color VARCHAR(120),
    storage_capacity INT,
    price DECIMAL(10,2),
    operating_system VARCHAR(130));
...
VALUES
  ...
  (14, 'Nokia', '7.1', 2018, 'Gloss Midnight Blue', 64, 349.00, 'Android'); -- errror
...
CREATE TABLE projects (
    ...
    alter table projects modify column project_name VARCHAR(200);
	alter table projects modify column project_status VARCHAR(200);
	alter table projects modify column client_name VARCHAR(200);
    
    INSERT INTO projects (project_id, project_name, project_description, start_date, end_date, project_manager_id, project_budget, department_id, project_status, client_name)
VALUES
...
CREATE TABLE customers (
    ...
    alter table customers modify column customer_name VARCHAR(200);
	alter table customers modify column customer_email VARCHAR(200);
    alter table customers modify column customer_address VARCHAR(200);
    alter table customers modify column customer_phone VARCHAR(200);
    alter table customers modify column customer_city VARCHAR(200);
    alter table customers modify column customer_state VARCHAR(200);
    alter table customers modify column customer_postal_code VARCHAR(200);
    alter table customers modify column customer_country VARCHAR(200);
    
    
    INSERT INTO customers (customer_id, customer_name, customer_email, customer_address, customer_phone, customer_city, customer_state, customer_country, customer_postal_code, customer_registration_date)
VALUES
...
CREATE TABLE reviews (
    ...
    alter table reviews modify column rating DECIMAL(13,5);
	alter table reviews modify column review_title VARCHAR(200);
